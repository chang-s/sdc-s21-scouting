document.addEventListener("DOMContentLoaded", () => {
  ...
  const rankIcons = {
    "Gold": "https://static.wikia.nocookie.net/leagueoflegends/images/6/6c/Season_2023_-_Gold.png",
    "Platinum": "https://static.wikia.nocookie.net/leagueoflegends/images/2/2a/Season_2023_-_Platinum.png",
  ...
  function renderPlayerCards() {
    ...
    playerData.forEach(player => {
      ...
      card.innerHTML = `
        ...
        <p><strong>Rank:</strong> ${player.rank}${rankIcon ? ` <img src="${rankIcon}" class="inline w-6 h-6 ml-1" title="${player.rank}"/>` : ""}</p>
